package EXERCISEencapsulation.pizzaCalories;
...
public class Topping {
    ...
    public double calculateCalories() {
        ...
        double t = this.getModifiersByToppingType(this.toppingType);
       // double sum = (this.weight * 2) * this.getModifiersByToppingType(this.toppingType);
        double sum = w * t;
        return sum;
    }
